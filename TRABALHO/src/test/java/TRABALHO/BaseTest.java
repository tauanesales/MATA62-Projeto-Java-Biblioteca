...
public class BaseTest {
  ...
  public void init() {
    ...
    exemplar1 =
        new Exemplar(1001, 1, "Teste 1", "Editora 1", "Autor 1", "1ª", "2001");
    exemplar2 =
        new Exemplar(1002, 2, "Teste 2", "Editora 2", "Autor 2", "2ª", "2002");
    ...
    // List<Aluno> alunos =
    //     List.of(new AlunoGraduacao(123, "João da Silva"),
    ...
    List.of(aluno, alunoGrad, alunoPosGrad, exemplar1, exemplar2)
        .stream()
