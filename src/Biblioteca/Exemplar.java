...
public class Exemplar extends Livro {
    ...
    public Exemplar(int codigo_identificador_livro, int codigo_identificador_exemplar, String titulo, String editora, String autores, String edicao, String ano_da_publicacao) {
